class Play {
  ...
  movePlayer() {
    if (this.arrow.left.isDown || this.wasd.left.isDown || this.moveLeft) {
      this.player.body.velocity.x = -200;
      this.player.anims.play('left', true);
    } else if (this.arrow.right.isDown || this.wasd.right.isDown || this.moveRight) {
      this.player.body.velocity.x = 200;
    ...
    if ((this.arrow.up.isDown || this.wasd.up.isDown) && this.player.body.onFloor()) {
